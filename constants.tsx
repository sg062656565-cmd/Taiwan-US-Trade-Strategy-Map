...
export const SUPPLY_CHAIN_SHIFTS = [
  ...
  { 
    ...
    from: '中國', 
    to: '墨西哥', 
    move: '中資企業規避第 301 條款與芬太尼相關制裁，移往北美。', 
    focus: '規避對中直接出口限制，利用墨西哥作為北美前哨站。', 
    latLngFrom: [114.0, 30.0], 
    latLngTo: [-102.5, 23.6],
    report: '正面臨 USMCA 2026 檢討壓力，美方要求嚴查中資零部件比例。'
  },
  { 
    company: '墨西哥近岸外包 (台資)', 
    from: '臺灣', 
    to: '墨西哥', 
    move: '臺灣電子代工與傳產加速赴墨，服務北美汽車與資通訊市場。', 
    focus: '服務北美在地客戶，規避第 122 條款帶來的物流不確定性。', 
    latLngFrom: [121.0, 24.0], 
    latLngTo: [-103.5, 21.0],
    report: 'ART 協定架構下，台墨供應鏈整合被視為分散洗產地風險的關鍵。'
  },
  { 
    company: '電子代工 (鴻海/廣達)', 
    from: '中國', 
